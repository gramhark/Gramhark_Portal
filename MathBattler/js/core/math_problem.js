...
const FLOOR_TABLES = {
    ...
    3: [
        ...
        { min: 26,  max: 30,  type: 'kuku' },
        { min: 31,  max: 35,  type: 'add2_1_c' },
        { min: 36,  max: 40,  type: 'sub2_1_b' },
        { min: 41,  max: 45,  type: 'div2_1_nr1' },
        { min: 46,  max: 50,  type: 'add2_2_nc' },
        { min: 51,  max: 55,  type: 'sub2_2_nb' },
        { min: 56,  max: 60,  type: 'add2_2_c' },
        { min: 61,  max: 65,  type: 'sub2_2_b' },
    ...
    2: [
        ...
        { min: 16,  max: 20,  type: 'add2_1_nc' },
        { min: 21,  max: 25,  type: 'sub2_1_nb' },
        { min: 26,  max: 35,  type: 'kuku' },
        { min: 36,  max: 45,  type: 'add2_1_c' },
        { min: 46,  max: 55,  type: 'sub2_1_b' },
        { min: 56,  max: 60,  type: 'div2_1_nr1' },
        { min: 61,  max: 65,  type: 'add2_2_nc' },
        { min: 66,  max: 70,  type: 'sub2_2_nb' },
        { min: 71,  max: 75,  type: 'add2_2_c' },
        { min: 76,  max: 80,  type: 'sub2_2_b' },
        { min: 81,  max: 90,  type: 'div2_1_nr2' },
        { min: 91,  max: 100, type: 'mul2_1_3',  bossType: 'mul2_1_9' },
    ],
    // ★（小学1・2年生）
    1: [
